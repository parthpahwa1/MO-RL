...
model_loc = '../Best Models/dst/multihead3_Q_dst_2022_06_21minloss_tensor(0.0907)_eps_1868.pkl'
# model_loc = '../saved_models/multihead3_Q_without_exemplar_dst_2022_06_24minloss_tensor(0.1465)_eps_1047.pkl'
# model_loc = '../saved_models/multihead3_Q_without_wLSE_exemplardst_2022_06_24minloss_tensor(0.2504)_eps_1767.pkl'
...
if args.pltcontrol:
    ...
    layout_opt = dict(title="Deep Sea Treaure Control Frontier",
        xaxis=dict(title='Treasure value'),
