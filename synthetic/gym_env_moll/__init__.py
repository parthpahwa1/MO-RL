...
register(
    id='MultiObj-LunarLander-v0',
    entry_point='gym.envs.multiobjective:LunarLander',
    max_episode_steps=2000,
    reward_threshold=300,
)

register(
    id='MultiObj-LunarLander-Continuous-v0',
    entry_point='gym.envs.multiobjective:LunarLanderContinuous',
    max_episode_steps=2000,
    reward_threshold=300,
)
