...
# model_loc = './FT7/4/multihead3_Q_eps4_up75_log_ft7_2022_06_21minloss_tensor(0.1438)_eps_2373.pkl'
model_loc = './FT7/16/multihead3_Q_eps4_up75_log_ft7_2022_06_21minloss_tensor(0.0888)_eps_2946.pkl'
...
if args.pltpareto:
    ...
    for j in range(10):
        ...
        pred = []
        for i in range(2000):
            probe = np.abs(np.random.randn(6))
            ...
            if i%4 == 0:
                ...
                preference += 1e-6
                w_e = np.random.dirichlet(preference)
                w = w_e
        ...
        f1_stats.append(act_f1)
        print('mean f1:', np.mean(f1_stats))
        print('std dev f1:', np.var(f1_stats)**0.5)
