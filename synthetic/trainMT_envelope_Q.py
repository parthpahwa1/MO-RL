...
parser.add_argument('--gamma', type=float, default=0.999, metavar='GAMMA',
...
def train(env, agent, args):
    ...
    for num_eps in range(args.episode_num+1):
        ...
        print("eps %d reward (1) %0.2f, the Q is %0.2f | %0.2f; the probe is %0.2f | %0.2f; q_loss: %0.4f;" % (
            num_eps,
            tot_reward,
            act_1,
            act_2,
        ...
        if (num_eps+1) % 150 == 0:
            agent.save(save_loc, save_file_name+"_envelope_eps_"+str(num_eps))
