...
# CONFIG
parser.add_argument('--env-name', default='ft7', metavar='ENVNAME',
...
parser.add_argument('--episode-num', type=int, default=5000, metavar='EN',
...
def train(env, agent, args):
    log_file_str = './logs/multihead3_Q_' + args.env_name + '_' + str(datetime.today().strftime("%Y_%m_%d")) + '.json'
    save_loc = './saved_models/'
    save_file_name = 'multihead3_Q_no_wLSE_' + args.env_name + '_' + str(datetime.today().strftime("%Y_%m_%d"))
